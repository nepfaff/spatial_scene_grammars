...
from pydrake.all import ApplyVisualizationConfig, StartMeshcat, VisualizationConfig
...
ApplyVisualizationConfig(
    config=config, builder=builder, scene_graph=scene_graph, meshcat=meshcat_instance, plant=plant
)
